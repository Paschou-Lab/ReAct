...
All three modules accept tab or space separated summary statistics of case-control GWAS as input, with `SNP`, `CHR`, `BP`, `A1`, `A2`, `OR` and `SE` as mandatory fields, and can be run by specifying a plain text file with designated parameters. 
