...
**Please contact us if you identify any bugs while using this version of ReACt. We would also welcome all feedback and suggestions!**
...
We also provided codes for the simulator we used to generate synthetic data (toy input). Please see the [readme file in Simulator](https://github.com/Paschou-Lab/ReAct/tree/main/Simulator) for more details. 
